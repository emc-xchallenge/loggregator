...
var _ = Describe("WebsocketServer", func() {
	...
	var sinkManager = sinkmanager.New(1024, false, false, blacklist.New(nil), loggertesthelper.Logger(), 100, "dropsonde-origin", 1*time.Second, 0, 1*time.Second, 500*time.Millisecond)
	var appId = "my-app"
